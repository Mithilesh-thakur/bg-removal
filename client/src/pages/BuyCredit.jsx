...
const BuyCredit = () => {
  return (
    <div className="min-h-[75vh] text-center pt-14 mb-10">
      <button className="border border-gray-400 px-8 py-2 mb-13 rounded-full">Our Plans </button>
      ...
      <div className="flex flex-wrap justify-center gap-6 text-left  ">
        {plans.map((item,index) =>(
          <div key={index} className="bg-white drop-shadow-sm border rounded-lg py-12 px-8 text-gray-700 hover:scale-105 transition-all duration-500 ">
            ...
            <button className="w-full bg-gray-900 text-white mt-8 text-sm rounded-md py-2.5 min-w-52 ">Purchase</button>
          </div>
