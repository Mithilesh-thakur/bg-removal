  ...
  return (
    <div className="pb-16">
      ...
      <div className="text-center mb-24">
        ...
        <label
          htmlFor="upload2"
          className="inline-flex px-8 py-3.5 gap-3 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700"
        >
