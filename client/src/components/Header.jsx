    ...
    <div className="flex items-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:mx-44 sm:mt-20">
      <div>
        ...
        <div>
          ...
          <label htmlFor="upload1" className="inline-flex px-8 py-3.5 gap-3 rounded-full cursor-pointer bg-gradient-to-r from-violet-600 to-fuchsia-500 m-auto hover:scale-105 transition-all duration-700" >
            <img width={20} src={assets.upload_btn_icon} alt="" />
            <p className="text-white test-sm">Upload your image</p>
          </label>
        </div>
      </div>
